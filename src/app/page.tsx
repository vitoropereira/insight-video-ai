...
export default function Home() {
  ...
  const {
    ...
    api: `${env.NEXT_PUBLIC_VERCEL_URL}/api/ai/generate`,
    body: {
      videoId,
      temperature,
    },
      ...
      <main className="flex-1 p-6 flex gap-6">
        <div className="flex flex-col flex-1 gap-4">
          ...
          <p className="text-sm text-muted-foreground">
            ...
            <code className="text-yellow-300">{"{transcription}"}</code> no seu
            prompt para adicionar o conteúdo_ da transcrição do vídeo
            selecionado.
          </p>
        </div>
